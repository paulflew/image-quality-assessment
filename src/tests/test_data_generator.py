...
TEST_SAMPLES = [
    {
        'image_file': '42039.jpg',
        'label': [0, 5, 10, 28, 54, 31, 12, 3, 3, 2]
    },
    {
        'image_file': '42040.jpg',
        'label': [0, 5, 10, 28, 54, 31, 12, 3, 3, 2]
    },
    {
        'image_file': '42041.jpg',
        'label': [0, 5, 10, 28, 54, 31, 12, 3, 3, 2]
    },
    {
        'image_file': '42042.jpg',
        'label': [0, 5, 10, 28, 54, 31, 12, 3, 3, 2]
    },
    {
...
class TestTrainDataGenerator(unittest.TestCase):
    ...
    def test_train_data_generator(self):
        dg = TrainDataGenerator(TEST_SAMPLES, IMG_DIR, BATCH_SIZE, N_CLASSES, BASENET_PREPROCESS, shuffle=False)
